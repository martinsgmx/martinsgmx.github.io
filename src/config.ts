...
export const themeConfig: ThemeConfig = {
  // SITE INFO ///////////////////////////////////////////////////////////////////////////////////////////
  site: {
    website: 'https://martinsgmx.github.io/',
    title: 'blog',
    author: 'martinsg',
    description: 'Personal blog - code, thoughts, prompts (?)',
    language: 'en-US'
  },
  ...
  post: {
    ...
    linkCard: false // Disable link card for GitHub Pages (requires server-side functionality)
  }
}
